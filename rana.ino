...
void loop(){
 ...
 for(p = 1; path[p] != 0; p++)
 {
  ...
  if(path[p] == live)
   {
    near = path[p-1];
    weight = fabs(current_lat.toFloat()- (info[near-1][1])) +
fabs(current_long.toFloat() - (info[near-1][2]));
    weight*=1000;
   }
...
switch(source){
   ...
   delay(4000);
   case 12 : Serial.println(" Indian Bank"); break;
   delay(4000);
   case 9 : Serial.println(" Canteen"); break;
   delay(4000);
   case 10 : Serial.println(" Boys Hostel"); break;
   delay(4000);
   case 11 : Serial.println("E Block"); break;
   delay(4000);
 ...
 Serial.flush();
   delay(4000);
      ...
      Serial.println("2) Admin Block");
       delay(4000);
      Serial.println("3) Gate");
       delay(4000);
      Serial.println("4) Library"); delay(3000);
      Serial.println("5) A block "); delay(3000);
      Serial.println("6) B block"); delay(3000);
      Serial.println("7) C block"); delay(3000);
      Serial.println("8) D block"); delay(3000);
      Serial.println("9) E block"); delay(3000);
      Serial.println("10) Canteen"); delay(3000);
      Serial.println("11) Boys Hostel "); delay(3000);
      Serial.println("12) Girls Hostel "); delay(3000);
