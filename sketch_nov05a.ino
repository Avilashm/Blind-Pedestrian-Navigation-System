...
Serial.print("next_lat = "); 
Serial.print(next_lat);
Serial.println("next_long = ");
Serial.print(next_long);
Serial.println("--------------DESTBRNG-----------------");
delay(2000);
...
Serial.print("lasttime_lat = "); 
Serial.print(lasttime_lat);
Serial.println("lasttime_long = ");
Serial.print(lasttime_long);                                  
Serial.print("Current_lat = "); 
Serial.print(current_lat);
Serial.println("Current_long = ");
Serial.print(current_long);
delay(2000);
Serial.println("--------------USRBRNG-----------------");//next_long
  //  Serial.println("------------------------------------------------------------------");
